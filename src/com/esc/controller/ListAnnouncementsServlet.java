...
@WebServlet("/listannouncements.html")
public class ListAnnouncementsServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {	
			if (connection != null) {
				ResultSet announcementslist = SQLOperations.getListAnnouncements(connection); 			
