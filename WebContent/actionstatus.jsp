...
<title>Item Registration Status</title>
</head>
			...
			<div class="panel panel-default" style="width: 50%; border: 0; margin-top: 50px;">
			  ...
			  <div class="panel-body" style="margin-top:padding-bottom: 30px;">
				...
				if (request.getParameter("success").equals("true")) { %>
					...
					<br/>
					<p><strong>Item:</strong> ${itemBean.item}</p>
					<p><strong>Description:</strong> ${itemBean.description}</p>
					<p><strong>Date:</strong> ${itemBean.date}</p>
					<p><strong>Found At:</strong> ${itemBean.foundat}</p>
					<p><strong>Found By:</strong> ${itemBean.foundby}</p> 
				<% } else { %>
				  <h1>Something went wrong while processing your request</h1>		
				<% } %> 
				<hr>
				<p>Click <a href="index3.jsp">here</a> to display the menu.</p>
				</div>
				</div>
		</center>
		</div>
